        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nick = table.Column<string>(type: "NVARCHAR(70)", nullable: false),
                    NumeroLogin = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Empresa = table.Column<string>(type: "nvarchar(255)", nullable: false),
                    URL = table.Column<string>(type: "nvarchar(255)", nullable: false),
                    Web = table.Column<string>(type: "nvarchar(255)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Titulo = table.Column<string>(type: "nvarchar(255)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProyectoImg_Proyecto_ProyectoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProyectoImg_ProyectoId",
                table: "ProyectoImg",
                column: "ProyectoId");
        }
